          ...
          children: [
            TextFormField(
              ...
              validator: (value) {
                ...
                if (uri == null || !uri.hasScheme) {
                  return '请输入有效的仓库地址（如 https://... 或 git@...）';
                }
                if (!url.startsWith('http://') && 
                    !url.startsWith('https://') && 
                    !url.startsWith('git@')) {
                  return '请输入有效的仓库地址（支持 https:// 或 git@ 格式）';
                }
                return null;
              },
            ),
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                ...
                hintText: 'GitHub Personal Access Token 或 GitLab Token',
                ...
                return Column(
                  children: [
                    ...
                    ElevatedButton.icon(
                      ...
                      label: Text(appState.isLoading ? '处理中...' : '保存并克隆仓库'),
