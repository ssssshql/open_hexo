...
class AboutScreen extends StatelessWidget {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.upcoming, color: Color.lerp(Colors.grey, Colors.lightBlue, 0.2)),
                const SizedBox(width: 8),
                Text(
                  '开发路线图',
                  style: Theme.of(context).textTheme.titleMedium?.copyWith(
            ...
            ...features.map((feature) => Padding(
              ...
              child: Row(
                children: [
                  Icon(feature['icon'] as IconData, size: 20, color: Colors.grey.shade600),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.volunteer_activism, color: Color.lerp(Colors.grey, Colors.teal, 0.2)),
                const SizedBox(width: 8),
                Text(
                  '开源致谢',
                  style: Theme.of(context).textTheme.titleMedium?.copyWith(
  ...
  Widget _buildDonationCard(BuildContext context) {
    const donationImageUrl = 'https://picgo.19991029.xyz/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20260327021640_47_2.png';
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.favorite, color: Color.lerp(Colors.grey, Colors.red, 0.2)),
                const SizedBox(width: 8),
                Text(
                  '捐赠',
                  style: Theme.of(context).textTheme.titleMedium?.copyWith(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Icon(Icons.people, color: Color.lerp(Colors.grey, Colors.orange, 0.35)),
                    const SizedBox(width: 8),
                    Text(
                      '捐赠名单',
                      style: Theme.of(context).textTheme.titleMedium?.copyWith(
